...
require (
	...
	github.com/strangelove-ventures/ibctest/v6 v6.0.0-20230113214030-cfaab3066448
...
require (
	...
	github.com/strangelove-ventures/lens v0.5.2-0.20230113204415-75acf3475f1a // indirect
