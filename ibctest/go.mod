...
require (
	...
	github.com/strangelove-ventures/ibc-test-framework v0.0.0-20220422171029-e573c7ee6685
...
require (
	...
	github.com/strangelove-ventures/lens v0.3.1-0.20220407203447-bcb1fa2e7b3a // indirect
