...
* [\#1196](https://github.com/cosmos/relayer/pull/1196) Add missing `EventTypeChannelClosed`, `EventTypeUpgradeChain ` and `EventTypeUpgradeClientProposal` when parse from event.
