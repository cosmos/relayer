...
require (
	...
	github.com/icon-project/ibc-integration v1.0.0
...
replace (
	...
	github.com/icon-project/ibc-integration => github.com/icon-project/ibc-integration v1.0.1-0.20231030122034-eba3565c0499
