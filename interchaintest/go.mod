...
replace (
	...
	github.com/cosmos/ibc-go/v7 => github.com/polymerdao/ibc-go/v7 v7.0.0-rc0.0.20230322062908-c76e54b2c5eb
	// For this nested module, you always want to replace the parent reference with the current worktree.
	github.com/cosmos/relayer/v2 => ../

	github.com/gogo/protobuf => github.com/regen-network/protobuf v1.3.3-alpha.regen.1

	github.com/strangelove-ventures/interchaintest/v7 => github.com/polymerdao/interchaintest/v7 v7.0.0-20230404004128-a0c6949d798f
