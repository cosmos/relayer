...
// handleMsgConnectionOpenInit will construct the start of the MsgConnectionOpenTry
// for the counterparty chain. PathProcessor will determine if this is needed.
// For example, if a MsgConnectionOpenTry or MsgConnectionOpenConfirm is
...
// for the counterparty chain. PathProcessor will determine if this is needed.
// For example, if a MsgConnectionOpenAck is not detected on the counterparty chain,
