...
func (cc *CosmosProvider) SendMsgsWith(ctx context.Context, msgs []sdk.Msg, memo string, gas uint64, signingKey string, feegranterKey string) (*relayerclient.ResultBroadcastTx, error) {
	sdkConfigMutex.Lock()
...
func (cc *CosmosProvider) PrepareFactory(txf tx.Factory, signingKey string) (tx.Factory, error) {
	...
	cliCtx := client.Context{}.
		// WithClient(cc.ConsensusClient). // TODO:
