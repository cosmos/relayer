...
func (cc *PenumbraProvider) AddKey(name string, coinType uint32) (output *provider.KeyOutput, err error) {
...
// It fails if there is an existing key with the same address.
func (cc *PenumbraProvider) RestoreKey(name, mnemonic string, coinType uint32) (address string, err error) {
