...
import (
	...
	v1alpha12 "github.com/cosmos/relayer/v2/relayer/chains/penumbra/core/component/chain/v1alpha1"
	v1alpha13 "github.com/cosmos/relayer/v2/relayer/chains/penumbra/core/component/dex/v1alpha1"
	v1alpha14 "github.com/cosmos/relayer/v2/relayer/chains/penumbra/core/component/fee/v1alpha1"
...
func (m *StatePayload_Note) GetSource() *v1alpha12.NoteSource {
	if m != nil {
		return m.Source
	}
	return nil
...
func (m *StatePayload_Swap) GetSource() *v1alpha12.NoteSource {
	if m != nil {
		return m.Source
	}
	return nil
...
var fileDescriptor_7db33c115ee8eed4 = []byte{
	...
	,
}
