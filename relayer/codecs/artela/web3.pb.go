...
func init() {
	proto.RegisterType((*ExtensionOptionsWeb3Tx)(nil), "artela.types.v1.ExtensionOptionsWeb3Tx")
}

func init() { proto.RegisterFile("artela/types/v1/web3.proto", fileDescriptor_9eb7cd56e3c92bc3) }
