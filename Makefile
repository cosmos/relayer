...
get-gaia:
	@mkdir -p ./chain-code/
	# @git clone --depth=1 https://github.com/cosmos/gaia.git ./chain-code/gaia
	@git clone --depth=1 --branch=$(GAIA_VERSION) https://github.com/oshorefueled/gaia.git ./chain-code/gaia
